/**
 * Level 2 - 进阶技能: 06 Database Sqlite
 * 
 * 📖 学习目标：
 * 完成本案例后，你应该能够：
 * 1. ✅ 连接 SQLite 数据库
 * 2. ✅ 使用 SQL 执行 CREATE TABLE
 * 3. ✅ 实现 INSERT 插入数据
 * 4. ✅ 实现 SELECT 查询数据
 * 5. ✅ 实现 UPDATE 和 DELETE 操作
 * 
 * ⚠️ 注意事项：
 * - 默认端口 3015
 * - 确保SQLite服务已启动
 ...
 * 
 * 运行：bun run src/02-intermediate/06-database-sqlite.ts
 * 测试：http://localhost:3015
 */
